...
struct MeshRendererComponent {
    ...
    std::vector<rp::BasicIndexedGuid> m_MaterialGuid{ static_cast<rp::BasicIndexedGuid>(rp::TypeNameGuid<"material">{}) }; ///< GUID of the material asset
...
private:
     ...
     */
    std::variant<std::shared_ptr<Mesh>, std::vector<std::shared_ptr<Mesh>>*> LoadMeshResource(const MeshRendererComponent& meshComp) const;
